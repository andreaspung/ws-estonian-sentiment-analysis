...
if __name__ == '__main__':
    ...
    model = Cosine(
        ...
        n_steps=len(train_data.examples),
    ...
    """
    searched_paras = {'batch_size': 16, 'optimizer_lr': 3e-05, 'optimizer_weight_decay': 0.0001,
     'teacher_update': 50, 'thresh': 0.5, 'lamda': 0.01, 'mu': 1, 'margin': 0.1, 'dropout': 0.3}
    print("Evaluation")
    for i in range(5):
        print("i", i)
        model = Cosine(
